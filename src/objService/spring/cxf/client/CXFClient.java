...
import objService.spring.cxf.server.HelloWorld;
...
public class CXFClient {
	...
	public static void main(String[] args) {
		...
		proxy.setAddress("http://localhost:8080/helloworld");
		...
		OutSOAPMonitorIntercepter soapOut = new OutSOAPMonitorIntercepter();
		proxy.getOutInterceptors().add(soapOut);
